...
> **Tip:** The image is ~20GB. Consider spinning up a cheap helper VM in Nebius,
> SSH into it, and do the build+push from there to avoid slow uploads and disk issues locally.
...
## Task 3 — Create an mk8s Cluster on Nebius Cloud

> **This is the most expensive part.** Only create the cluster once Docker image is pushed
> and SkyPilot is ready, so you can run the job immediately and tear down quickly.
